...
* Submit a ticket for your [issue](https://github.com/DavidBruchmann/t3quotes/issues), assuming the issue to report is not yet mentioned in an existing report.
  * Clearly describe the purpose of the report (bug, feature-request, ...) including steps to reproduce if it's a bug.
...
For changes of a trivial nature, it's not always necessary to create a new issue.

## Additional resources

* [Rendered documentation](https://docs.typo3.org/typo3cms/extensions/t3quotes/)
  This source will be available only after submit of version t3quotes-2.1.0
